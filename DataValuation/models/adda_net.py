...
class AddaNet(nn.Module):
    ...
    def __init__(self, model='LeNet', num_cls=10, discrim_feat=False, src_weights_init=None, weights_init=None):
    ...
    def setup_net(self):
        ...
        input_dim = self.src_net.output_dim if self.discrim_feat else self.num_cls
